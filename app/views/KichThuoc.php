                                            ...
                                            <td>
                                                <div class="table-actions">
                                                    <?php
                                                        if ($quyen == 1) {
                                                            ?>
                                                            <form id="deleteFormKT_<?php echo $kichThuoc -> getMaKT(); ?>"
                                                                  action="../controllers/C_KichThuoc.php" method="POST">
                                                                <input type="hidden" name="makt"
                                                                       value="<?php echo $kichThuoc -> getMaKT(); ?>">
                                                                <button type="button"
                                                                        class="btn btn-danger table-action-button"
                                                                        data-makt="<?php echo $kichThuoc -> getMaKT(); ?>"
                                                                        onclick="confirmDeleteKT(this)">Xoá
                                                                </button>
                                                            </form>
                                                            <?php
                                                        }
                                                    ...
                                                    <?php
                                                        if ($quyen == 1 || $quyen == 2) {
                                                            ...
                                                            <button type="button"
                                                                    ...
                                                                    data-bs-target="#editModal<?php echo $kichThuoc -> getMaKT(); ?>">
                                                                Sửa
                                                            </button>
                                                            <?php
                                                        }
                                                    ...
                                                    <div class="modal fade"
                                                         id="editModal<?php echo $kichThuoc -> getMaKT(); ?>"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="../controllers/C_KichThuoc.php"
                                                                          method="POST">
                                                                        <div class="mb-3">
                                                                            <label for="makt_edit" class="form-label">Mã
                                                                                màu:</label>
                                                                            <input type="text" class="form-control"
                                                                                   id="makt_edit" name="makt_edit"
                                                                                   value="<?php echo $kichThuoc -> getMaKT(); ?>"
                                                                                   readonly>
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label for="tenkt_edit" class="form-label">Tên
                                                                                màu:</label>
                                                                            <input type="text" class="form-control"
                                                                                   id="tenkt_edit" name="tenkt_edit"
                                                                                   value="<?php echo $kichThuoc -> getTenKT(); ?>"
                                                                                   required>
                                                                        </div>
                        ...
                        <ul class="pagination">
                            <?php for ($i = 1; $i <= $numberOfPage; $i++) {
                                ...
                                <li class="page-item <?php if ($i == $page)
                                    echo 'active'; ?>">
                                    <a class="page-link"
                                       href="KichThuoc.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
