        ...
        <div class="container mt-4">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="modal fade" id="addModalSanpham" tabindex="-1" aria-labelledby="addModalSanphamLabel"
                         aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="../controllers/C_SanPham.php" method="POST"
                                                            ...
                                                            while ($row_color = $result_colors -> fetch_assoc()) {
                                                                ...
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                           name="mausac[]"
                                                                           id="mausac_<?php echo $row_color["mamau"]; ?>"
                                                                           value="<?php echo $row_color["tenmau"]; ?>">
                                                                    <label class="form-check-label"
                                                                           for="mausac_<?php echo $row_color["mamau"]; ?>">
                                                        ...
                                                        if ($result_sizes -> num_rows > 0) {
                                                            while ($row_size = $result_sizes -> fetch_assoc()) {
                                                                ...
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                           name="kichthuoc[]"
                                                                           id="kichthuoc_<?php echo $row_size["makt"]; ?>"
                                                                           value="<?php echo $row_size["tenkt"]; ?>">
                                                                    <label class="form-check-label"
                                                                           for="kichthuoc_<?php echo $row_size["makt"]; ?>">
                    ...
                    <?php
                        ...
                        list($listSanPham, $totalRecords) = $SanPhamModel -> layDanhSach($recordPerPage, $offset);
                                ...
                                <?php
                                    if ($quyen == 1) {
                                        ...
                                        <button type="button" class="btn btn-primary ms-4" data-bs-toggle="modal"
                                                data-bs-target="#addModalSanpham">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 d-flex justify-content-between">
                                            <div class="dropdown">
                                                <label for="maloai_filter" class="visually-hidden">Danh mục sản
                                                    phẩm:</label>
                                                <select id="maloai_filter" name="maloai_filter" class="form-select"
                                            ...
                                            <div class="dropdown">
                                                <button style="color: black;" class="btn btn-light dropdown-toggle"
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="colorDropdown"
                                                    ...
                                                    <button type="button" class="btn btn-primary" onclick="updateUrl()">
                                                        Lọc
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="number" class="form-control" id="minPrice"
                                                           name="minPrice" placeholder="Giá từ">
                                                </div>
                                                <!-- Giá đến -->
                                                <div class="col-md-6">
                                                    <input type="number" class="form-control" id="maxPrice"
                                                           name="maxPrice" placeholder="Giá đến">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <form id="sortForm" action="SanPham.php" method="GET">
                                                    <select class="form-select" id="sort" name="sort">
                                                        <option value="default" <?php if (!isset($_GET['sort']) || $_GET['sort'] == 'default')
                                                            echo 'selected'; ?>>Mặc định
                                                        </option>
                                                        <option value="price_desc" <?php if (isset($_GET['sort']) && $_GET['sort'] == 'price_desc')
                                                            echo 'selected'; ?>>Giá cao đến thấp
                                                        </option>
                                                        <option value="price_asc" <?php if (isset($_GET['sort']) && $_GET['sort'] == 'price_asc')
                                                            echo 'selected'; ?>>Giá thấp đến cao
                                                        </option>
                                                    </select>
                                                </form>
                                            </div>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <form action="SanPhamCT.php" method="GET">
                                                        <input type="hidden" name="masp"
                                                               value="<?php echo $sanPham -> getMaSP(); ?>">
                                                        <div class="image-container">
                                                            <?php
                                                                $hinhanh_path = "../../public/assets/images/" . $sanPham -> getHinhAnh();
                                                            ?>
                                                            <button type="submit" class="btn btn-link p-0 m-0"><img
                                                                        src="<?php echo $hinhanh_path; ?>"
                                                                        class="card-img-top" alt="image"></button>
                                                        </div>
                                                    </form>

                                                    <div class="card-body">
                                                        <h4 class="card-title">
                                                            <a href="SanPhamCT.php?masp=<?php echo $sanPham -> getMaSP(); ?>"
                                                            ...
                                                            <div class="card-footer">
                                                                <div class="table-actions"
                                                                    ...
                                                                    <?php
                                                                        if ($quyen == 1) {
                                                                            ?>
                                                                            <form id="deleteFormSP_<?php echo $sanPham -> getMaSP(); ?>"
                                                                                  action="../controllers/C_SanPham.php"
                                                                                  method="POST">
                                                                                <input type="hidden" name="masp"
                                                                                       value="<?php echo $sanPham -> getMaSP(); ?>">
                                                                                <button type="button"
                                                                                        class="btn btn-danger table-action-button"
                                                                                        onclick="confirmDeleteSP('<?php echo $sanPham -> getMaSP(); ?>')">
                                                                                    Xoá
                                                                                </button>
                                                                            </form>
                                                                            <?php
                                                                    ...
                                                                    <?php
                                                                        if ($quyen == 1 || $quyen == 2) {
                                                                            ...
                                                                            <button type="button"
                                                                                    ...
                                                                                    data-bs-target="#editModalSanpham<?php echo $sanPham -> getMaSP(); ?>">
                                                                                Sửa
                                                                            </button>
                                                                            <?php
                                                                        }
                                                                    ...
                                                                    <div class="modal fade"
                                                                         id="editModalSanpham<?php echo $sanPham -> getMaSP(); ?>"
                                                                         tabindex="-1"
                                                                         aria-labelledby="editModalSanphamLabel<?php echo $sanPham -> getMaSP(); ?>"
                                                                         aria-hidden="true">
                                                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title"
                                                                                        id="editModalSanphamLabel<?php echo $sanPham -> getMaSP(); ?>">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <form action="../controllers/C_SanPham.php"
                                                                                          method="POST"
                                                                                          enctype="multipart/form-data">
                                                                                        <div class="row">
                                                                                            <!-- Cột 1: Các trường nhập -->
                                                                                            <div class="col-md-4">
                                                                                                ...
                                                                                                <div class="mb-3">
                                                                                                    ...
                                                                                                    <input type="text"
                                                                                                           ...
                                                                                                           id="tensp_edit"
                                                                                                           name="tensp_edit"
                                                                                                           value="<?php echo $sanPham -> getTenSP(); ?>"
                                                                                                           required>
                                                                                                </div>
                                                                                                <div class="mb-3">
                                                                                                    <label for="gia_edit"
                                                                                                    ...
                                                                                                    <input type="number"
                                                                                                           ...
                                                                                                           id="gia_edit"
                                                                                                           name="gia_edit"
                                                                                                           value="<?php echo $sanPham -> getGia(); ?>"
                                                                                                           min="0"
                                                                                                           required>
                                                                                                </div>
                                                                                                <div class="mb-3">
                                                                                                    <label for="soluong_edit"
                                                                                                           class="form-label">Số
                                                                                                        lượng:</label>
                                                                                                    <input type="number"
                                                                                                           class="form-control"
                                                                                                           id="soluong_edit"
                                                                                                           name="soluong_edit"
                                                                                                           value="<?php echo $sanPham -> getSoLuong(); ?>"
                                                                                                           min="0"
                                                                                                           required>
                                                                                                </div>
                                                                                                <div class="mb-3">
                                                                                                    <label for="maloai_edit"
                                                                                                           class="form-label">Tên
                                                                                                        loại:</label>
                                                                                                    <select class="form-select"
                                                                                                        ...
                                                                                                        <?php
                                                                                                            ...
                                                                                                            if ($result_categories -> num_rows > 0) {
                                                                                                                while ($row_category = $result_categories -> fetch_assoc()) {
                                                                                                                    ?>
                                                                                                                    <option value="<?php echo $row_category["maloai"]; ?>" <?php if ($row_category["maloai"] == $sanPham -> getMaLoai())
                                                                                                                        echo 'selected'; ?>><?php echo $row_category["tenloai"]; ?></option>
                                                                                                                    <?php
                                                                                                                }
                                                                                                            }
                                                                                                        ?>
                                                                                            ...
                                                                                            <div class="col-md-3">
                                                                                                <div class="mb-3">
                                                                                                    <label for="mausac_edit"
                                                                                                           class="form-label">Màu
                                                                                                        sắc:</label>
                                                                                                    <?php
                                                                                                            ...
                                                                                                            while ($row_color = $result_colors -> fetch_assoc()) {
                                                                                                                ...
                                                                                                                <div class="form-check">
                                                                                                                    <input class="form-check-input"
                                                                                                                           type="checkbox"
                                                                                                                           name="mausac_edit[]"
                                                                                                                           id="mausac_edit_<?php echo $row_color["mamau"]; ?>"
                                                                                                                           value="<?php echo $row_color["tenmau"]; ?>" <?php echo $isChecked; ?>>
                                                                                                                    <label class="form-check-label"
                                                                                                                           for="mausac_edit_<?php echo $row_color["mamau"]; ?>">
                                                                                                                        <?php echo $row_color["tenmau"]; ?>
                                                                                                                    </label>
                                                                                                                </div>
                                                                                                                <?php
                                                                                                ...
                                                                                                <div class="mb-3">
                                                                                                    <label for="kichthuoc_edit"
                                                                                                           class="form-label">Kích
                                                                                                        thước:</label>
                                                                                                    <?php
                                                                                                            ...
                                                                                                            while ($row_size = $result_sizes -> fetch_assoc()) {
                                                                                                                ...
                                                                                                                <div class="form-check">
                                                                                                                    <input class="form-check-input"
                                                                                                                           type="checkbox"
                                                                                                                           name="kichthuoc_edit[]"
                                                                                                                           id="kichthuoc_edit_<?php echo $row_size["makt"]; ?>"
                                                                                                                           value="<?php echo $row_size["tenkt"]; ?>" <?php echo $isChecked; ?>>
                                                                                                                    <label class="form-check-label"
                                                                                                                           for="kichthuoc_edit_<?php echo $row_size["makt"]; ?>">
                                                                                                                        <?php echo $row_size["tenkt"]; ?>
                                                                                                                    </label>
                                                                                                                </div>
                                                                                                                <?php
                                                                                            ...
                                                                                            <div class="col-md-5">
                                                                                                <div class="mb-3">
                                                                                                    <label for="hinhanh_edit_<?php echo $sanPham -> getMaSP(); ?>"
                                                                                                           class="form-label">Hình
                                                                                                        ảnh:</label>
                                                                                                    <input type="file"
                                                                                                           class="form-control"
                                                                                                           id="hinhanh_edit_<?php echo $sanPham -> getMaSP(); ?>"
                                                                                                           name="hinhanh_edit"
                                                                                                           accept="image/*"
                                                                                                           onchange="previewNewImage_<?php echo $sanPham -> getMaSP(); ?>()">
                                                                                                </div>
                                                                                                <!-- Hiển thị hình ảnh mới khi được chọn -->
                                                                                                <div id="newImagePreview_<?php echo $sanPham -> getMaSP(); ?>"
                                                                                                     class="mt-3"
                                                                                                     style="display: none;">
                                                                                                    <p>Xem trước hình
                                                                                                        ảnh mới:</p>
                                    ...
                                    <ul class="pagination">
                                        <?php for ($i = 1; $i <= $numberOfPage; $i++) {
                                            ...
                                            <li class="page-item <?php if ($i == $page)
                                                echo 'active'; ?>">
                                                <a class="page-link"
                                                   href="SanPham.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
