  ...
  <div class="container mt-4">
    <div class="m-lg-1 d-flex justify-content-between align-items-center mb-3">
      ...
      <div class="d-flex align-items-center">
        ...
        if ($quyen == 1) {
        ?>
          <button type="button" class="btn btn-primary ms-4" data-bs-toggle="modal" data-bs-target="#addModalLSP">
    ...
    <div class="modal fade" id="addModalLSP" tabindex="-1" aria-labelledby="addModalLSPLabel" aria-hidden="true">
              ...
              <tr>
                ...
                <td>
                  <div class="table-actions">
                    ...
                    if ($quyen == 1) {
                    ?>
                      <form id="deleteFormLSP_<?php echo $loaiSanPham->getMaloai(); ?>" action="../controllers/C_LoaiSanPham.php" method="POST">
                        <input type="hidden" name="maloai" value="<?php echo $loaiSanPham->getMaloai(); ?>">
                        <button type="button" class="btn btn-danger table-action-button" data-maloai="<?php echo $loaiSanPham->getMaloai(); ?>" onclick="confirmDeleteLSP(this)">Xoá</button>
                      </form>
                    <?php
                    }
                    ?>
                    ...
                    if ($quyen == 1 || $quyen == 2) {
                    ?>
                      <button type="button" class="btn btn-primary table-action-button" data-bs-toggle="modal" data-bs-target="#editModal<?php echo $loaiSanPham->getMaloai(); ?>">
                        Sửa
                      </button>
                    <?php
                    }
                    ...
                    <div class="modal fade" id="editModal<?php echo $loaiSanPham->getMaloai(); ?>" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel">Chỉnh sửa loại sản phẩm</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                          </div>
                          <div class="modal-body">
                            <form action="../controllers/C_LoaiSanPham.php" method="POST">
                              <div class="mb-3">
                                <label for="maloai_edit" class="form-label">Mã loại:</label>
                                <input type="text" class="form-control" id="maloai_edit" name="maloai_edit" value="<?php echo $loaiSanPham->getMaloai(); ?>" readonly>
                              </div>
                              <div class="mb-3">
                                <label for="tenloai_edit" class="form-label">Tên loại:</label>
                                <input type="text" class="form-control" id="tenloai_edit" name="tenloai_edit" value="<?php echo $loaiSanPham->getTenloai(); ?>" required>
                              </div>
        ...
        <ul class="pagination">
          ...
          ?>
            <li class="page-item <?php if ($i == $page) echo 'active'; ?>">
              <a class="page-link" href="LoaiSanPham.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
