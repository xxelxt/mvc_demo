...
<div class="d-flex justify-content-between align-items-center">
    ...
    <?php if ($quyen == 1) { ?>
      <div class="dropdown" style="margin: 5px 5px;">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          ...
          <li><a class="dropdown-item <?php isActive('LoaiSanPham'); ?>" href="LoaiSanPham.php">Loại sản phẩm</a></li>
          <li><a class="dropdown-item <?php isActive('MauSac'); ?>" href="MauSac.php">Màu sắc</a></li>
          <li><a class="dropdown-item <?php isActive('KichThuoc'); ?>" href="KichThuoc.php">Kích thước</a></li>
  ...
  <div class="d-flex align-items-center">
    ...
    if (isset($_SESSION['user'])) { ?>
      ...
      <div class="dropdown">
        <button class="btn dropdown-toggle me-2" type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
          <?php echo $_SESSION['user']; ?>
        </button>
        <ul class="dropdown-menu" aria-labelledby="userDropdown">
          <li><a class="dropdown-item" href="../controllers/C_AuthProcess.php?action=logout">Đăng xuất</a></li>
        </ul>
      </div>
    <?php } else { ?>
