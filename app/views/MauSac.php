                                            ...
                                            <td>
                                                <div class="table-actions">
                                                    <?php
                                                        if ($quyen == 1) {
                                                            ?>
                                                            <form id="deleteFormMS_<?php echo $mauSac -> getMaMau(); ?>"
                                                                  action="../controllers/C_MauSac.php" method="POST">
                                                                <input type="hidden" name="mamau"
                                                                       value="<?php echo $mauSac -> getMaMau(); ?>">
                                                                <button type="button"
                                                                        class="btn btn-danger table-action-button"
                                                                        data-mamau="<?php echo $mauSac -> getMaMau(); ?>"
                                                                        onclick="confirmDeleteMS(this)">Xoá
                                                                </button>
                                                            </form>
                                                            <?php
                                                        }
                                                    ...
                                                    <?php
                                                        if ($quyen == 1 || $quyen == 2) {
                                                            ...
                                                            <button type="button"
                                                                    ...
                                                                    data-bs-target="#editModal<?php echo $mauSac -> getMaMau(); ?>">
                                                                Sửa
                                                            </button>
                                                            <?php
                                                        }
                                                    ...
                                                    <div class="modal fade"
                                                         id="editModal<?php echo $mauSac -> getMaMau(); ?>"
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="../controllers/C_MauSac.php"
                                                                          method="POST">
                                                                        <div class="mb-3">
                                                                            <label for="mamau_edit" class="form-label">Mã
                                                                                màu:</label>
                                                                            <input type="text" class="form-control"
                                                                                   id="mamau_edit" name="mamau_edit"
                                                                                   value="<?php echo $mauSac -> getMaMau(); ?>"
                                                                                   readonly>
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label for="tenmau_edit" class="form-label">Tên
                                                                                màu:</label>
                                                                            <input type="text" class="form-control"
                                                                                   id="tenmau_edit" name="tenmau_edit"
                                                                                   value="<?php echo $mauSac -> getTenMau(); ?>"
                                                                                   required>
                                                                        </div>
