        ...
        <?php if ($quyen == 1) : ?>
            ...
            <div class="input-group">
              ...
              <button type="submit" name="submit_search" class="btn btn-primary">Tìm kiếm</button>
                        ...
                        <?php
                            if ($quyen == 1) {
                                ...
                                <button type="button" class="btn btn-primary ms-4" data-bs-toggle="modal"
                                        data-bs-target="#addModalTaikhoan">
                ...
                <div class="modal fade" id="addModalTaikhoan" tabindex="-1" aria-labelledby="addModalTaikhoanLabel"
                     aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <form action="../controllers/C_TaiKhoan.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="priv" name="priv" min="0"
                                               required>
                                    </div>
                                            ...
                                            <td>
                                                <div class="table-actions">
                                                    <?php
                                                        if ($quyen == 1) {
                                                            ?>
                                                            <form id="deleteFormTK_<?php echo $taiKhoan -> getUsername(); ?>"
                                                                  action="../controllers/C_TaiKhoan.php" method="POST">
                                                                <input type="hidden" name="username"
                                                                       value="<?php echo $taiKhoan -> getUsername(); ?>">
                                                                <button type="button"
                                                                        class="btn btn-danger table-action-button"
                                                                        data-user="<?php echo $taiKhoan -> getUsername(); ?>"
                                                                        onclick="confirmDeleteTK(this)">Xoá
                                                                </button>
                                                            </form>
                                                            <?php
                                                        }
                                                    ...
                                                    <?php
                                                        if ($quyen == 1 || $quyen == 2) {
                                                            ...
                                                            <button type="button"
                                                                    ...
                                                                    data-bs-target="#editModalTaikhoan<?php echo $taiKhoan -> getUsername(); ?>">
                                                                Sửa
                                                            </button>
                                                            <?php
                                                        }
                                                    ...
                                                    <div class="modal fade"
                                                         id="editModalTaikhoan<?php echo $taiKhoan -> getUsername(); ?>"
                                                         tabindex="-1"
                                                         aria-labelledby="editModalTaikhoanLabel<?php echo $taiKhoan -> getUsername(); ?>"
                                                         aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        id="editModalTaikhoanLabel<?php echo $taiKhoan -> getUsername(); ?>">
                                                                        Chỉnh sửa tài khoản</h5>
                                                                    <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
                                                                            aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <form action="../controllers/C_TaiKhoan.php"
                                                                          method="POST">
                                                                        <div class="mb-3">
                                                                            <label for="username_edit"
                                                                                   class="form-label">Tên tài
                                                                                khoản:</label>
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="password" class="form-control"
                                                                                   id="password_edit"
                                                                                   name="password_edit"
                                                                                   value="<?php echo $taiKhoan -> getPassword(); ?>"
                                                                                   required>
                                                                        </div>
                                                                        <div class="mb-3">
                                                                            <label for="priv_edit" class="form-label">Quyền:</label>
                                                                            <input type="number" class="form-control"
                                                                                   id="priv_edit" name="priv_edit"
                                                                                   value="<?php echo $taiKhoan -> getPriv(); ?>"
                                                                                   min="0" required>
                                                                        </div>
                        ...
                        <ul class="pagination">
                            <?php for ($i = 1; $i <= $numberOfPage; $i++) {
                                ...
                                <li class="page-item <?php if ($i == $page)
                                    echo 'active'; ?>">
                                    <a class="page-link"
                                       href="TaiKhoan.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
